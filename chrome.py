...
# This script only supports Google Chrome, if you need another version download it from the GitHub repo (https://github.com/WillStOnge/HealthyNKUScript)
#
...
# You will also need to download Google's chromedriver (https://sites.google.com/a/chromium.org/chromedriver) and add it to your PATH (https://helpdeskgeek.com/windows-10/add-windows-path-environment-variable/).
# Once you've added it to your PATH, you will probably need to restart your computer for the script to run.
# 
# Usage: python chrome.py NKU_Username NKU_Password
# 
# Example: python chrome.py stongew1 password123
# 
...
if len(sys.argv) < 3:
    print('Usage: python chrome.py username password')
    exit(3)
...
driver.find_element_by_css_selector('#tab1 > div.panel.panel-default > div.panel-body > div.row > div.form-group > div:nth-child(2) > div > label:nth-child(4)').click()
driver.find_element_by_css_selector('#tab1 > div.panel.panel-default > div.panel-body > div.row > div.row.text-center > a').click()

# Scroll down.
driver.execute_script("window.scrollBy(0, 2000);")

# Do the second page and move on to the third.
driver.find_element_by_css_selector('#tab2 > div > div.panel-body > div.row > div:nth-child(1) > div.row.justify-content-center > div > label:nth-child(4)').click()
driver.find_element_by_css_selector('#tab2 > div > div.panel-body > div.row > div:nth-child(3) > div:nth-child(2) > div > label:nth-child(4)').click()
driver.find_element_by_css_selector('#tab2 > div > div.panel-body > div.row > div.row.text-center > a:nth-child(2)').click()

# Scroll down.
driver.execute_script("window.scrollBy(0, 2000);")

# Do the third page and submit the form.
driver.find_element_by_css_selector('#tab3 > div > div.panel-body > div.row > div.form-group > div:nth-child(2) > div > label:nth-child(4)').click()
driver.find_element_by_css_selector('#tab3 > div > div.panel-body > div.row > div.row.text-center > button').click()
